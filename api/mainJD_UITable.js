...
async function main() {
  ...
  async function renderTables(table) {
    ...
    const topImg = ['aHR0cDovL210dy5zby81UkRyZ1M=', 'aHR0cDovL210dy5zby81Q0JyY0E=',
'aHR0cDovL210dy5zby81djlxcnA=']
  ...
  async function updateVersion(title, desc) {
    ...
    if (index === 0) return;
    const modulePath = F_MGR.joinPath(path, 'jingDong.js');
    const reqUpdate = new Request('https://gitcode.net/4qiao/scriptable/raw/master/table/jingDong_UITable.js');
